...
from .utils import GAMEPAD_SUPPORTED, NUMPY_SUPPORTED, RAW_EXTENSIONS, RAW_SUPPORTED
...
class WorkerSignals(QObject):
    ...
    exif_loaded = pyqtSignal(str, dict)  # path, exif_data
        ...
        try:
            ...
            if qimage is None or qimage.isNull():
                ...
                if not self._is_cancelled:
                    exif_data = extract_exif(self.path)
                    self.signals.exif_loaded.emit(self.path, exif_data)
